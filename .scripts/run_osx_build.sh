...
validate_recipe_outputs "gobject-introspection-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="gobject-introspection-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi